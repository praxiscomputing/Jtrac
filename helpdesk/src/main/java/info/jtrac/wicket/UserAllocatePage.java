...
public class UserAllocatePage extends BasePage {
    ...
    private class UserAllocateForm extends Form {                
		...
		public UserAllocateForm(String id) {
            ...
            DropDownChoice dropDownLevel = new DropDownChoice("level", levels, new IChoiceRenderer() {
            	
            	public Object getDisplayValue(Object object) {
					return ((Level)object).getLevel();
				}
            ...
            allocateButton = new Button("allocate") {
                ...
                public void onSubmit() {  
                    ...
                    List<SpaceUserLevel> spaceUserLevels = getJtrac().getSpaceUserLevel(space, user);
                    
                    if(spaceUserLevels == null ||  spaceUserLevels.isEmpty()) {
                    	SpaceUserLevel spaceUserLevel = new SpaceUserLevel();
                    	spaceUserLevel.setSpace(space);
                    	spaceUserLevel.setLevel(level);
                    	spaceUserLevel.setUser(user);
                    	
                    	getJtrac().storeSpaceUserlevel(spaceUserLevel);
                    }
