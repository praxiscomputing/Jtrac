...
public class ItemViewFormPanel extends BasePanel {
    ...
    private class ItemViewForm extends Form {
        ...
        private DropDownChoice reasonOutstanding;
		...
		public ItemViewForm(String id, final Item item) {
            ...
            //====================================================
            List<ReasonOutstanding> reasonOutstandingList = new ArrayList<ReasonOutstanding>();
            reasonOutstandingList = getJtrac().findAllReasons();
            
            reasonOutstanding = new DropDownChoice("reasonOutstanding", new PropertyModel(history, "reasonOutstanding"), reasonOutstandingList, new IChoiceRenderer() {
				
				public String getIdValue(Object object, int index) {
					return ((ReasonOutstanding)object).getId() + "";
				}
				
				public Object getDisplayValue(Object object) {
					return ((ReasonOutstanding)object).getdescription();
				}
			}); 
            add(reasonOutstanding);
        //=======================================================    
        ...
        protected void onSubmit() {
            ...
            String formattedText = Jsoup.parse(history.getComment()).text();
            history.setComment(formattedText);
            
            User user = JtracSession.get().getUser();
            history.setLoggedBy(user);
            history.setSpaceSeverityPeriod(this.item.getSpaceSeverityPeriod());
