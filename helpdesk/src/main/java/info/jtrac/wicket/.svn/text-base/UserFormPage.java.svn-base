...
public class UserFormPage extends BasePage {
	...
	private class UserForm extends Form {
        ...
        private boolean useCellPhoneNumber;
		...
		public boolean isUseCellPhoneNumber() {
			return useCellPhoneNumber;
		}

		public void setUseCellPhoneNumber(boolean useCellPhoneNumber) {
		...
		public UserForm(String id, final User user) {
            ...
            add(locked);
            // allow sms =======================================================
            WebMarkupContainer useCellPhoneNumber = new WebMarkupContainer("useCellPhoneNumber");
            useCellPhoneNumber.add(new CheckBox("user.useCellPhoneNumber"));
            add(useCellPhoneNumber);
            // name ============================================================
         ...
         // cellphone ===========================================================
            add(new TextField("user.cellPhoneNumber").setRequired(false));
            // locale ==========================================================
