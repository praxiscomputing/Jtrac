...
public class SpaceAllocatePage extends BasePage {
    ...
    private DropDownChoice levelChoice;
        ...
        public SpaceAllocateForm(String id) {
            ...
            allocateButton = new Button("allocate") {
                ...
                public void onSubmit() {  
                	...
                	spaceUserLevel.setLevel((Level)levelChoice.getModelObject());
            ...
            levelChoice.setRequired(true);
            levelChoice.add(new ErrorHighlighter());
