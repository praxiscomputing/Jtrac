...
public class HeaderPanel extends BasePanel {    
    ...
    public HeaderPanel() {
        ...
        if(user.getId() == 0) {
            ...
            //add(new WebMarkupContainer("reports").setVisible(false));
            add(new Link("login") {
                public void onClick() {
        	...
        	/*add(new Link("reports") {
				...
				public void onClick() {
					...
					//String reportURL = "http://jtracsrv:8081/birt/frameset?__report=report\\IssueTracking.rptdesign";
					//getRequestCycle().setRequestTarget(new RedirectRequestTarget( reportURL ));
				}
			});*/
            ...
            add(new Link("logout") {
                public void onClick() {                                        
                    ...
                    if(logoutUrl != null) {
                        ...
                        setResponsePage(LoginPage.class, new PageParameters("locale=" + user.getLocale()));
                    }
                }            
            });
