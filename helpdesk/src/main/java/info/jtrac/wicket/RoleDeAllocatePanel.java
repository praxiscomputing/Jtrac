            ...
            protected void populateItem(ListItem roleKeyItem) {
                ...
                Button deallocate = new Button("deallocate") {
                    ...
                    public void onSubmit() {
                        ...
                        List<UserSpaceRole> tempExists = getJtrac().loadUserSpaceRole(usr.getUser(), usr.getSpace());
                        if(tempExists == null || tempExists.isEmpty()) {
                            getJtrac().removeSpaceUserLevel(usr.getSpace(), usr.getUser());
                        }
