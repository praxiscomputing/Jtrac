	...
	public UserListPage() {              
        ...
        ListView listView = new ListView("users", userListModel) {
            protected void populateItem(ListItem listItem) {                
                ...
                listItem.add(new Label("cellPhoneNumber", new PropertyModel(user, "cellPhoneNumber")));
                listItem.add(new Label("useCellPhoneNumber", new PropertyModel(user, "useCellPhoneNumber")));
