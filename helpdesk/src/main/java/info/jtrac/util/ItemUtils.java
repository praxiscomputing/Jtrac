...
public final class ItemUtils {    
	...
	private static String getAsHtml(Item item, HttpServletRequest request, HttpServletResponse response, 
        ...
        sb.append("</tr>");
        sb.append("<tr>");
        sb.append("  <td valign='top'" + labelStyle + ">" + "Category" + "</td>");
        sb.append("  <td colspan='5'" + tdStyle + ">" + fixWhiteSpace(item.getCategory().getDescription()) + "</td>");
        sb.append("</tr>");
        sb.append("<tr" + altStyle + ">");
        sb.append("  <td" + labelStyle + ">" + "Priority" + "</td>");
        sb.append("  <td colspan='5'" + tdStyle + ">" + item.getSpaceSeverityPeriod().getSeverity().getDescription() + "</td>");
        sb.append("</tr>");
        sb.append("<tr>");
        sb.append("  <td" + labelStyle + ">" + "Date Logged" + "</td>");
        sb.append("  <td colspan='5'" + tdStyle + ">" + new SimpleDateFormat("dd-MM-yyyy").format(item.getDateAdded()) + "</td>");
        sb.append("</tr>");
        ...
        sb.append("  <th" + thStyle + ">" + fmt("loggedBy", ms, loc) + "</th><th" + thStyle + ">" + fmt("status", ms, loc) + "</th>"
                + "<th" + thStyle + ">" + fmt("assignedTo", ms, loc) + "</th><th" + thStyle + ">" + fmt("comment", ms, loc) + "</th><th" + thStyle + ">" + "Reason Outstanding" + "</th><th" + thStyle + ">" + fmt("timeStamp", ms, loc) + "</th>");
        ...
        if (item.getHistory() != null) {
            ...
            for(History history : item.getHistory()) {
                ...
                sb.append("  </td>");
                sb.append("  <td" + tdStyle + ">");
                if(history.getReasonOutstanding() != null)
                	sb.append(history.getReasonOutstanding().getdescription());
                else
                	sb.append("");
                sb.append("  </td>");
                sb.append("  <td" + tdStyle + ">" + DateUtils.formatTimeStamp(history.getTimeStamp()) + "</td>");
                for(Field field : editable) {
    ...
    public static Element getAsXml(Item item) {
        ...
        if (item.getDetail() != null) {
            ...
            root.addElement("detail").addText(Jsoup.parse(item.getDetail()).text());
        }
        // logged by
