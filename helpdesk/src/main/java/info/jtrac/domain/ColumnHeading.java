                ...
                case DATE_ADDED:
                	return new Processor() {
                        ...
                        Fragment getFilterUiFragment(MarkupContainer container, User user, Space space, Jtrac jtrac) {
                            ...
                            //AjaxDatePicker calendar = new AjaxDatePicker("value", new PropertyModel(filterCriteria, "value"));
