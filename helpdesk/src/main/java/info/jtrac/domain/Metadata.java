...
public class Metadata implements Serializable {    
    ...
    public void initRoles() {
      ...
      //================== NEWLY ADDED ============================
        states.put(State.ON_HOLD, "On Hold");
        //===========================================================
        states.put(State.CLOSED, "Closed");
        
        addRole("DEFAULT");
        toggleTransition("DEFAULT", State.NEW, State.OPEN);
        toggleTransition("DEFAULT", State.OPEN, State.ON_HOLD);
        toggleTransition("DEFAULT", State.OPEN, State.CLOSED);
        toggleTransition("DEFAULT", State.OPEN, State.OPEN);
        //================== NEWLY ADDED ============================
        toggleTransition("DEFAULT", State.ON_HOLD, State.OPEN);
        toggleTransition("DEFAULT", State.ON_HOLD, State.CLOSED);
        toggleTransition("DEFAULT", State.ON_HOLD, State.ON_HOLD);
        //===========================================================
        toggleTransition("DEFAULT", State.CLOSED, State.OPEN);
        toggleTransition("DEFAULT", State.CLOSED, State.ON_HOLD);
    }
